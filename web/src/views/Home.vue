  ...
  <div class="home-container">
    ...
    <footer class="footer">
      <div class="footer-content">
        <button @click="showFriendLinks = true" class="friend-link-btn" style="display: none;"><!-- 隐藏原始友情链按钮 -->
        ...
        <p class="copyright">Copyright © 2025 Nav-Item | <a href="https://github.com/Jinyinghui/Nav-Item" target="_blank" class="footer-link">Powered by eooce</a></p>
      </div>
    </footer>
